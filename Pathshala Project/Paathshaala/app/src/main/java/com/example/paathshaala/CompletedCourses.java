...
//===================================
        ...
        DatabaseReference ref2 = database.getReference().child("StudentCourseCompleted").child(s2);
        ...
        try {
            ...
            q.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    String cp=p1.getCoursestudied();
                    String cp1=p1.getCoursetaught();
                    passcp(cp) ;
                    passcp1(cp1);
...
//        }
        ...
        DatabaseReference ref1 = database.getReference().child("CoursesCompleted");
...
//        }
        ...
        try {
            ...
            q.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    // e1.setText(keylist.get(1));
                    dothis1(valuelist,keylist,cnamelist,inamelist,feelist,datelist);
                }
    ...
    public void dothis1(List<String> valuelist,List<String> keylist,List<String> cnamelist,List<String> inamelist,List<String> feelist,List<String> datelist){
