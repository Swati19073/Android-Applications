    ...
    public void dothis(List<String> valuelist,List<String> keylist,List<String> cnamelist,List<String> inamelist,List<String> datelist,List<String> feelist){
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                Intent it=getIntent();
                String check=it.getStringExtra("fromteacherhome");
                ...
                if(check.equals("0"))
                {
                    ...
                    intent.putExtra("key", keyTemplist.get(position));
                ...
                if(check.equals("1"))
                {
                    Intent das=new Intent(MyCourses.this,EditCoursedetail.class);
                    das.putExtra("key",keyTemplist.get(pos).toString());
                    startActivity(das);
            //     Toast.makeText(getApplicationContext(),""+keyTemplist.get(pos),Toast.LENGTH_LONG).show();
                }
